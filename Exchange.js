...
describe('Exchange', () => {
	...
	beforeEach(async () => {
		...
		token1 = await Token.deploy('Black Parade', 'BP', '1000000')
	...
	describe('Deployment', () => {
		...
		it('tracks the fee fee percent', async () => {
	...
	describe('Withdrawing Tokens', () => {
		...
		describe('Success', () => {
			...
			beforeEach(async () => {
				//depositing token before withdrawing
		...
		describe('Failure', () => {
			it('fails for insufficiet', async() => {
				await expect(exchange.connect(user1).depositToken(token1.address, amount)).to.be.reverted
			})
		})
	})
	...
	describe('Making Orders', () => {
		...
		describe('Success', async () => {
			beforeEach(async() => {
				...
				//depositing token before making order
